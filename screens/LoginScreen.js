    ...
    <View className="bg-white h-full w-full">
        ...
        <View className='w-full h-full flex justify-around pt-40 pb-10'>
            ...
            <View className="flex items-center mx-4 space-y-4">
                ...
                <Animated.View entering={FadeInDown.delay(400).duration(1500).springify()} className="bg-black/5 p-5 rounded-2xl w-full mb-4">
                    <TextInput placeholder="Password" placeholderTextColor={'gray'} secureTextEntry />
                </Animated.View>
                <Animated.View entering={FadeInDown.delay(600).duration(1500).springify()} className="w-full">
                    <TouchableOpacity
                ...
                <Animated.View entering={FadeInDown.delay(800).duration(1500).springify()} className="flex-row justify-center ">
